...
#if !defined(KRATOS_TOPOPT_SMALL_DISPLACEMENT_ELEMENT_H_INCLUDED )
#define  KRATOS_TOPOPT_SMALL_DISPLACEMENT_ELEMENT_H_INCLUDED
...
class TopOptSmallDisplacementElement
    : public Element
{
public:
    ...
    /// Counted pointer of TopOptSmallDisplacementElement
    KRATOS_CLASS_POINTER_DEFINITION( TopOptSmallDisplacementElement );
    ///@}
...
public:
    ...
    TopOptSmallDisplacementElement(IndexType NewId, GeometryType::Pointer pGeometry);

    TopOptSmallDisplacementElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    ///Copy constructor
    TopOptSmallDisplacementElement(TopOptSmallDisplacementElement const& rOther);

    /// Destructor.
    virtual ~TopOptSmallDisplacementElement();
    ...
    /// Assignment operator.
    TopOptSmallDisplacementElement& operator=(TopOptSmallDisplacementElement const& rOther);
    ...
    */
     ...
     */
    void Calculate(const Variable<double> &rVariable, double &rOutput, ProcessInfo &rCurrentProcessInfo);
...
protected:
    ...
    ///@{
    TopOptSmallDisplacementElement() : Element()
    {
    }
...
#endif // KRATOS_TOPOPT_SMALL_DISPLACEMENT_ELEMENT_H_INCLUDED  defined
