...
KratosSolidMechanicsApplication::KratosSolidMechanicsApplication():
    ...
    mPointTorqueCondition3D1N( 0, Condition::GeometryType::Pointer( new Point3D <Node<3> >( Condition::GeometryType::PointsArrayType( 1, Node<3>() ) ) ) ),
...
void KratosSolidMechanicsApplication::Register()
{
    ...
    std::cout << std::endl << "     KRATOS  __|  _ \\  |   |  _ \\              " << std::endl;
    std::cout              << "           \\__ \\ (   | |   | | , )             " << std::endl;
    std::cout              << "           ____/\\___/ ___|_| ___/ MECHANICS     " << std::endl;
    std::cout              << "Initializing KratosSolidMechanicsApplication..." << std::endl << std::endl;
