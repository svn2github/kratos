...
void  AddCustomUtilitiesToPython()
{
    ...
    // Daniel added
    class_<AdditionalUtilities, bases<Process> >("AdditionalUtilities", init<ModelPart&>())
            .def("create_PointLoad3DCondition", &AdditionalUtilities::create_PointLoad3DCondition)
            ;
    // Eof daniel added
}
