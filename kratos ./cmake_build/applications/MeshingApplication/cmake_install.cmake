# Install script for directory: /home/daniel/software/kratos/applications/MeshingApplication
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  ...
  ENDIF()
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/libs" TYPE SHARED_LIBRARY FILES "/home/daniel/software/kratos/cmake_build/applications/MeshingApplication/KratosMeshingApplication.so")
  IF(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/libs/KratosMeshingApplication.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/libs/KratosMeshingApplication.so")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/libs/KratosMeshingApplication.so"
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/KratosMultiphysics" TYPE FILE FILES "/home/daniel/software/kratos/applications/MeshingApplication/MeshingApplication.py")
ENDIF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")

IF(NOT CMAKE_INSTALL_LOCAL_ONLY)
  # Include the install script for each subdirectory.
  INCLUDE("/home/daniel/software/kratos/cmake_build/applications/MeshingApplication/custom_external_libraries/triangle/cmake_install.cmake")
  INCLUDE("/home/daniel/software/kratos/cmake_build/applications/MeshingApplication/custom_external_libraries/tetgen/tetgen1.4.3/cmake_install.cmake")
  INCLUDE("/home/daniel/software/kratos/cmake_build/applications/MeshingApplication/custom_external_libraries/msuite/cmake_install.cmake")
  INCLUDE("/home/daniel/software/kratos/cmake_build/applications/MeshingApplication/custom_external_libraries/tetMeshOpt/cmake_install.cmake")
